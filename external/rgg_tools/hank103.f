...
c
      ...
      subroutine hank103vec(zs,nz,h0s,h1s,ifexpon)
      implicit real *8 (a-h,o-z)
      complex *16 zs(*), h0s(*), h1s(*)
      integer nz, ifexpon, i

c$OMP PARALLEL DO default(shared) private(i) schedule(static)
      do i = 1,nz
         call hank103(zs(i),h0s(i),h1s(i),ifexpon)
      enddo
