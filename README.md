...
- Shidong Jiang, Hai Zhu, Fredrik Fryklund, Tristan Goodwill,
and Haiyang Wang made contributions to the core MATLAB library routines,
including RCIP methods, kernel-split quadrature, and iterative solvers.
