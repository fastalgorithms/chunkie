chunkermat_axissymhelm_transmissionTest_re0();


function chunkermat_axissymhelm_transmissionTest_re0()
iseed = 8675309;
rng(iseed);
...
% Set up kernels
Skdiff     = kernel('axissymhelmdiff', 's', [zk zk/2]);
Dkdiff     = kernel('axissymhelmdiff', 'd', [zk zk/2]);
Skpdiff    = kernel('axissymhelmdiff', 'sprime', [zk zk/2]);
Dkpdiff    = kernel('axissymhelmdiff', 'dprime', [zk zk/2]);
...
Dik    = kernel('axissymhelm', 'd', zk/2);
Sik    = kernel('axissymhelm', 's', zk/2);
Sikp    = kernel('axissymhelm', 'sprime', zk/2);
