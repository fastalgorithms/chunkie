...
sourcesm = sources;
sourcesm(2,:) = -sourcesm(2,:);
sources = [sources, sourcesm];
...
corners{1}.nedge = 1;
corners{1}.iedgechunks = [1;1];

corners{2}.clist = [1,2];
corners{2}.isstart = [0 1];
corners{2}.nedge = 1;
corners{2}.iedgechunks = [1;chnkr(1).nch];
