%BIEAPPLYTEST test the routines for a matrix free apply of the system
%matrix
%
% 
...
sysapply = @(sigma) bieapply(chnkr,fkern,-0.5,sigma,cormat);
...
sysapply = @(sigma) bieapply(chnkr,kerns,1,sigma,cormat);
...
sysapply = @(sigma) bieapply(cgrph,fkern,1,sigma,cormat);
